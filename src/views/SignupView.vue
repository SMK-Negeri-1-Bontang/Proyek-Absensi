            ...
            <form @submit.prevent="signup">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        type="text" placeholder="Masukkan nama" id="nama" name="nama" required v-model="form.nama">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100"
                        type="text" placeholder="Masukkan NIS" id="nis" name="nis" required v-model="form.nis">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100"
                        type="password" placeholder="Masukkan kata sandi" id="password" name="password" required v-model="form.password">
                ...
                <div class="flex flex-row gap-2">
                    <div class="mb-6">
                        ...
                        <select name="kelas"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100 bg-gray-800" id="kelas"
                    ...
                    <div class="mb-6">
                        ...
                        <select name="subdivisi"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100 bg-gray-800" id="subdivisi"
                    ...
                    <div class="mb-6">
                        ...
                        <select name="jurusan"
                            class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100 bg-gray-800" id="jurusan"
